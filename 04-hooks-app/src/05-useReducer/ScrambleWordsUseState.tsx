    ...
    return (
      <div className="min-h-screen bg-linear-to-br from-purple-100 via-blue-50 to-indigo-100 flex items-center justify-center p-4">
        <div className="w-full max-w-md mx-auto">
          <h1 className="text-4xl font-bold bg-linear-to-br from-purple-600 to-blue-600 bg-clip-text text-transparent mb-2">
          ...
          <CardContent className="p-8">
            ...
            <form onSubmit={handleGuessSubmit} className="mb-6">
              <div className="space-y-4">
                ...
                <Button
                  type="submit"
                  className="w-full bg-linear-to-br from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white font-semibold py-3 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200"
